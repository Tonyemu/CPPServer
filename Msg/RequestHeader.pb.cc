...
void protobuf_AssignDesc_RequestHeader_2eproto() {
  protobuf_AddDesc_RequestHeader_2eproto();
  ...
  static const int RequestHeader_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RequestHeader, host_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RequestHeader, need_response_),
  };
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_RequestHeader_2eproto);
}
...
void protobuf_AddDesc_RequestHeader_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\023RequestHeader.proto\022\021com.tonyemu.proto"
    "\"4\n\rRequestHeader\022\014\n\004host\030\001 \002(\t\022\025\n\rneed_"
    "response\030\002 \002(\010", 94);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "RequestHeader.proto", &protobuf_RegisterTypes);
  RequestHeader::default_instance_ = new RequestHeader();
  RequestHeader::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_RequestHeader_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_RequestHeader_2eproto {
  StaticDescriptorInitializer_RequestHeader_2eproto() {
    protobuf_AddDesc_RequestHeader_2eproto();
  }
} static_descriptor_initializer_RequestHeader_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int RequestHeader::kHostFieldNumber;
const int RequestHeader::kNeedResponseFieldNumber;
#endif  // !_MSC_VER

RequestHeader::RequestHeader()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:com.tonyemu.proto.RequestHeader)
}
...
RequestHeader::RequestHeader(const RequestHeader& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:com.tonyemu.proto.RequestHeader)
}
...
RequestHeader::~RequestHeader() {
  // @@protoc_insertion_point(destructor:com.tonyemu.proto.RequestHeader)
  SharedDtor();
}
...
const RequestHeader& RequestHeader::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_RequestHeader_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:com.tonyemu.proto.RequestHeader)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_need_response;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:com.tonyemu.proto.RequestHeader)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:com.tonyemu.proto.RequestHeader)
  return false;
#undef DO_
}
...
void RequestHeader::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:com.tonyemu.proto.RequestHeader)
  // required string host = 1;
  if (has_host()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->host().data(), this->host().length(),
  ...
  // required bool need_response = 2;
  if (has_need_response()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(2, this->need_response(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:com.tonyemu.proto.RequestHeader)
}

::google::protobuf::uint8* RequestHeader::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:com.tonyemu.proto.RequestHeader)
  // required string host = 1;
  if (has_host()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->host().data(), this->host().length(),
  ...
  // required bool need_response = 2;
  if (has_need_response()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(2, this->need_response(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:com.tonyemu.proto.RequestHeader)
  return target;
}
...
void RequestHeader::Swap(RequestHeader* other) {
  if (other != this) {
    ...
    std::swap(need_response_, other->need_response_);
