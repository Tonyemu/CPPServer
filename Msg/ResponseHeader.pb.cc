...
void protobuf_AssignDesc_ResponseHeader_2eproto() {
  protobuf_AddDesc_ResponseHeader_2eproto();
  ...
  static const int ResponseHeader_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ResponseHeader, state_code_),
  };
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_ResponseHeader_2eproto);
}
...
void protobuf_AddDesc_ResponseHeader_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024ResponseHeader.proto\022\021com.tonyemu.prot"
    "o\"$\n\016ResponseHeader\022\022\n\nstate_code\030\001 \002(\r", 79);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "ResponseHeader.proto", &protobuf_RegisterTypes);
  ResponseHeader::default_instance_ = new ResponseHeader();
  ResponseHeader::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_ResponseHeader_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_ResponseHeader_2eproto {
  StaticDescriptorInitializer_ResponseHeader_2eproto() {
    protobuf_AddDesc_ResponseHeader_2eproto();
  }
} static_descriptor_initializer_ResponseHeader_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int ResponseHeader::kStateCodeFieldNumber;
#endif  // !_MSC_VER

ResponseHeader::ResponseHeader()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:com.tonyemu.proto.ResponseHeader)
}
...
ResponseHeader::ResponseHeader(const ResponseHeader& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:com.tonyemu.proto.ResponseHeader)
}
...
ResponseHeader::~ResponseHeader() {
  // @@protoc_insertion_point(destructor:com.tonyemu.proto.ResponseHeader)
  SharedDtor();
}
...
const ResponseHeader& ResponseHeader::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_ResponseHeader_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:com.tonyemu.proto.ResponseHeader)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:com.tonyemu.proto.ResponseHeader)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:com.tonyemu.proto.ResponseHeader)
  return false;
#undef DO_
}
...
void ResponseHeader::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:com.tonyemu.proto.ResponseHeader)
  // required uint32 state_code = 1;
  if (has_state_code()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(1, this->state_code(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:com.tonyemu.proto.ResponseHeader)
}

::google::protobuf::uint8* ResponseHeader::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:com.tonyemu.proto.ResponseHeader)
  // required uint32 state_code = 1;
  if (has_state_code()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(1, this->state_code(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:com.tonyemu.proto.ResponseHeader)
  return target;
}
